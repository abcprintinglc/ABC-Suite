...
if (!function_exists('abc_b2b_designer_upload_base_dir')) {
...
if (!function_exists('abc_b2b_designer_upload_base_url')) {
...
if (!function_exists('abc_b2b_designer_token')) {
...
if (!function_exists('abc_b2b_designer_safe_float')) {
    function abc_b2b_designer_safe_float($value, $default = 0.0): float {
        if ($value === null || $value === '') {
...
if (!function_exists('abc_b2b_designer_current_user_org_id')) {
...
if (!function_exists('abc_b2b_designer_decode_data_url')) {
    function abc_b2b_designer_decode_data_url(string $data_url): ?array {
...
if (!function_exists('abc_b2b_designer_current_user_is_approved')) {
...
if (!function_exists('abc_b2b_designer_current_user_is_org_admin')) {
...
if (!function_exists('abc_b2b_designer_org_organizer_first_name')) {
    function abc_b2b_designer_org_organizer_first_name(int $org_id): string {
        ...
        $display_name = get_userdata($organizer_id)->display_name ?? '';
        $first = trim(explode(' ', trim($display_name))[0] ?? '');
        return $first ?: 'the organizer';
    }
}

if (!function_exists('abc_b2b_designer_upload_drafts_dir')) {
...
if (!function_exists('abc_b2b_designer_upload_drafts_url')) {
...
if (!function_exists('abc_b2b_designer_get_draft_editor_page_id')) {
...
if (!function_exists('abc_b2b_designer_get_draft_editor_url')) {
    function abc_b2b_designer_get_draft_editor_url(int $draft_id): string {
        $page_id = abc_b2b_designer_get_draft_editor_page_id();
        if ($page_id > 0) {
            return add_query_arg(['draft_id' => (int) $draft_id], get_permalink($page_id));
        }
        return add_query_arg(['draft_id' => (int) $draft_id], home_url('/'));
    }
}

if (!function_exists('abc_b2b_designer_reset_draft_ready_flags')) {
